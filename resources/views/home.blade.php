            ...
            {{--<div class="card">--}}
                ...
                {{--<div class="card-body">--}}
                 ...
                 {{--@foreach($address as $oneAddress)--}}
                    {{--<p>{{$oneAddress->name}}</p>--}}
                    {{--<p>{{$oneAddress->address}}</p>--}}
                    {{--<p>{{$oneAddress->house_number}}</p>--}}
                        {{--<br>--}}
                 {{--@endforeach--}}
                {{--</div>--}}
            {{--</div>--}}
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                <form action="{{route('address.update', $oneAddress->id)}}" id="update" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}

                    <a class="edit" onclick="document.getElementById('update').submit();"><i name="update" class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                </form>
            </td>
        </tr>
        @endforeach
